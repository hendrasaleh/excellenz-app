...
class Pengaturan_excellenzapp extends Member_Controller {
	private $kode_menu = 'user-excellenzapp';
	private $kelompok = 'pengaturan';
	private $url = 'manager/pengaturan_excellenzapp';
    ...
    public function index($page=null, $id=null){
        ...
        $this->template->display_admin($this->kelompok.'/pengaturan_excellenzapp_view', 'Pengaturan Excellenz App', $data);
    }
