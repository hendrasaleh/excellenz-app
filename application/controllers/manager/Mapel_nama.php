...
class Mapel_nama extends Member_Controller {
    ...
    public function index($page=null, $id=null){
		...
		$query_modul = $this->cbt_modul_model->get_by_kolom('modul_aktif',1);
        ...
        $this->template->display_admin($this->kelompok.'/mapel_view', 'Mata Pelajaran', $data);
    }
