...
<section class="content-header">
	<h1>
		Pengaturan Excellenz App
		<small>Melakukan pengaturan Identitas Excellenz App</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url(); ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Pengaturan Excellenz App</li>
	</ol>
</section>
			...
			<?php echo form_open($url.'/simpan','id="form-pengaturan"'); ?>
                <div class="box">
                    <div class="box-header with-border">
    					<div class="box-title">Daftar Pengaturan Excellenz App</div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p class="help-block">
									Nama Pelaksana Excellenz App.<br />
