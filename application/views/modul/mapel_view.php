                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Gambar (Pilih "No Image" untuk tes)</label>
                                <select class="form-control input-sm" id="tambah-gambar" name="tambah-gambar">
                                    <option value="default.jpg">No Image</option>
                                    <?php if(!empty($select_image)){ echo $select_image; } ?>
                                </select>
                            </div>
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label>Gambar</label>
                                <input type="text" class="form-control" id="edit-gambar" name="edit-gambar" readonly>
                            </div>
                            <div class="form-group">
                                <label>Status</label>
