    ...
    <section class="content">
        ...
        <div class="row">
            <div class="box box-primary box-solid">
                ...
                <div class="box-footer">
                    <button class="btn btn-default pull-right" id="btn-hentikan">Submit Tes</button>
                </div>
            </div><!-- /.box -->
        </div>
    </section><!-- /.content -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="trx-judul">Konfirmasi Submit Tes</div>
                </div>
				...
				<div class="box-footer">
					<button type="submit" id="tambah-simpan" class="btn btn-primary">Submit Tes</button>
