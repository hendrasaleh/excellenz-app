...
<section class="content">
    <div class="box box-primary collapsed-box">
        ...
        <div class="box-body">
            <dl>
                <dd>
                    Dengan menggunakan Excellenz App, maka anda setuju untuk :
                    <ol>
                        <li>Tidak mengubah Nama Aplikasi <b>Excellenz App</b> menjadi nama aplikasi lain</li>
                        <li>Tidak mengubah footer yang menunjukkan alamat website Excellenz App</li>
                        <li>Tidak menjual Excellenz App. Tetapi anda diperbolehkan untuk mengambil keuntungan dari jasa proses instalasi, konsultasi dan lain sebagainya yang berkaitan dengan Excellenz App</li>
                        <li>Tidak menhapus tribute dan Perjanjian Penggunaan</li>
                    </ol>
                    Semoga Excellenz App dapat bermanfaat untuk kita semua.
                </dd>
            </dl>
        </div><!-- /.box-body -->
    </div><!-- /.box -->
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif Excellenz App, yang memiliki platform dan bahasa user-friendly untuk membuat, mengelola dan melaksanakan ujian online.</p>
    </div>
    <div class="box">
        <div class="box-header with-border">
