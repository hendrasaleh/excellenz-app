...
<section class="content-header">
	<h1>
		Mata Pelajaran
		<small>Halaman untuk penambahan, pengubahan, dan penghapusan mata pelajaran berdasarkan Modul</small>
	</h1>
	<ol class="breadcrumb">
                        ...
                        <table id="table-topik" class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> 1 </td>
                                    <td> <?= $m->topik_nama; ?> </td>
                                    <td> <?= $m->topik_detail ?> </td>
                                    <td> <?= 0; ?> </td>
									<td> <?= $m->topik_aktif ?> </td>
                                    <td> <a href="<?= site_url('manager/mapel/edit/'.$m->topik_id); ?>"
                                             class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
                                            <a onclick="deleteConfirm('<?= site_url('manager/mapel/delete/'.$m->topik_id); ?>')"
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <p>NB : Jika Mapel dihapus, maka semua materi akan ikut terhapus !</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            Data Mata Pelajaran yang sudah dipilih akan dihapus beserta data materi didalamnya.
                            <br /><br />
